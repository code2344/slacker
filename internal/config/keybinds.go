...
type ConversationsTreeKeybinds struct {
	SelectionKeybinds
...
type Keybinds struct {
	ToggleConversationsTree Keybind `toml:"toggle_conversations_tree"`
	...
	FocusConversationsTree Keybind `toml:"focus_conversations_tree"`
	...
	ConversationsTree ConversationsTreeKeybinds `toml:"conversations_tree"`
...
func defaultConversationsTreeKeybinds() ConversationsTreeKeybinds {
	return ConversationsTreeKeybinds{
		SelectionKeybinds: defaultSelectionKeybinds(),
...
func defaultKeybinds() Keybinds {
	return Keybinds{
		...
		ConversationsTree: defaultConversationsTreeKeybinds(),
